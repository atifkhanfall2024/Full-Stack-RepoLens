  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 max-w-3xl">
        ...
        {/* Drag & Drop */}
        <div className="border-2 border-dashed border-gray-200 rounded-lg py-12 flex flex-col items-center justify-center text-gray-400 text-sm hover:border-blue-400">
